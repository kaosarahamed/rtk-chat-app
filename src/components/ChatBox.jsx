...
import { useEditConversationMutation } from "../redux/rtk/features/conversation/conversationApi";
...
function ChatBox({ messages }) {
  ...
  const participantUser =
    messages?.receiver.email !== loggedInUser.email
      ? messages.receiver
      : messages.sender;
  ...
  const handleSubmit = (e) => {
    ...
    editConversation({
      ...
      data: {
        ...
        user: [loggedInUser, participantUser],
        message,
